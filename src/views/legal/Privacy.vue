<template>
    <article class="page markdown-body">
        ...
        <p>
            Simon LEFORT, also known as &quot;Androz2091&quot; built the Dumpus app as an Open
            Source app. This SERVICE is provided by Simon LEFORT, also known as
            &quot;Androz2091&quot; at no cost and is intended for use as is.
        </p>
        <p>
        ...
        <p>
            ...
            Conditions, which are accessible at Dumpus unless otherwise defined in this Privacy
            Policy.
        </p>
        <h2>Information Collection and Use</h2>
        <p>
            For a better experience, while using our Service, I may require you to provide us with
            certain personally identifiable information, including but not limited to Discord
            package ID, encrypted Discord package data (only readable by you, using the key stored
            on your device). The information that I request will be retained on your device and is
        ...
        <p>This policy is effective as of 2023-06-19</p>
        <h2>Contact Us</h2>
        <p>
            If you have any questions or suggestions about my Privacy Policy, do not hesitate to
            contact me at contact@dumpus.app.
        </p>
        <p>
