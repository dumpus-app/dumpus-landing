<template>
    <article class="page markdown-body">
        ...
        <p>
            Simon LEFORT, also known as &quot;Androz2091&quot; built the Dumpus
            app as an Open Source app. This SERVICE is provided by Simon LEFORT,
            also known as &quot;Androz2091&quot; at no cost and is intended for
            use as is.
        </p>
        <p>
        ...
        <p>
            ...
            our Terms and Conditions, which are accessible at Dumpus unless
        ...
        <p>
            ...
            including but not limited to Discord package ID, encrypted Discord
            package data (only readable by you, using the key stored on your
            device). The information that I request will be retained on your
        ...
        <p>
            ...
            not hesitate to contact me at contact@dumpus.app.
        </p>
        <p>
