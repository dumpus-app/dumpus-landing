<template>
    <article class="page markdown-body">
        ...
        <p>
            ...
            related to it, still belong to Simon LEFORT, also known as
            &quot;Androz2091&quot;.
        </p>
        <p>
            Simon LEFORT, also known as &quot;Androz2091&quot; is committed to
            ensuring that the app is as useful and efficient as possible. For
            that reason, we reserve the right to make changes to the app or to
            charge for its services, at any time and for any reason. We will
            never charge you for the app or its services without making it very
            clear to you exactly what you’re paying for.
        </p>
        <p>
            The Dumpus app stores and processes personal data that you have
            ...
            phone’s security features and it could mean that the Dumpus app
        ...
        <p>
            You should be aware that there are certain things that Simon LEFORT,
            also known as &quot;Androz2091&quot; will not take responsibility
            ...
            by your mobile network provider, but Simon LEFORT, also known as
            &quot;Androz2091&quot; cannot take responsibility for the app not
        ...
        <p>
            Along the same lines, Simon LEFORT, also known as
            &quot;Androz2091&quot; cannot always take responsibility for the way
            ...
            avail the Service, Simon LEFORT, also known as
            &quot;Androz2091&quot; cannot accept responsibility.
        </p>
        <p>
            With respect to Simon LEFORT, also known as &quot;Androz2091&quot;’s
            ...
            available to you. Simon LEFORT, also known as &quot;Androz2091&quot;
        ...
        <p>
            ...
            the updates if you want to keep using the app. Simon LEFORT, also
            known as &quot;Androz2091&quot; does not promise that it will always
        ...
        <p>
            ...
            Conditions, do not hesitate to contact me at contact@dumpus.app.
        </p>
        <p>
